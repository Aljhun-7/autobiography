<x-layout>
    <main>
        <div class="album py-5 mt-5 bg-custom">
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4">
                        ...
                        <a class="card shadow-sm" href="#">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <small class="text-body-secondary">aljhunangala7@gmail.com</small>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col px-4">
                        <a class="card shadow-sm" href="#">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <small class="text-body-secondary">charlenehipolito19@gmail.com</small>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col px-4">
                        <a class="card shadow-sm" href="#">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <small class="text-body-secondary">markjademarzan@gmail.com</small>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col px-4">
                        <a class="card shadow-sm" href="#">
                            <img class="bd-placeholder-img card-img-top rounded-circle" width="100%" height="225" src="#" alt="wong"role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                            <div class="card-body">
